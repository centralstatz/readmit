...
The first thing we need to is extract the set of discharges (i.e., the _denominator_) that contribute to program for each cohort. To do this, we'll iterate through the different cohorts and sequentially use the `hsr_discharges()` function:
